      ...
      <div className="flex justify-center p-6">
        <div className="max-w-4xl">
          <div id="project-background">
            ...
            <p className="text-lg">
              The Quantum Proximity Gateway (QPG) is a highly advanced authentication system developed in collaboration with IBM. This system aims to revolutionise user authentication and access control by eliminating manual logins and streamlining user verification, through proximity detection, facial recognition, and AI-driven profile management.         
            </p>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  <p className="text-lg">
                    The QPG is designed for all users - from corporate employees in large organisations, to students and faculty members in universities, and even individuals who frequently switch between devices, this system offers seamless, context-aware authentication to enhance security and convenience for all. By integrating IBM's Granite 3.2 AI model and post-quantum cryptography, the system ensures effortless, adaptive authentication in a variety of work environments. In particular however, the QPG revolutionises accessibility for neurodivergent, elderly, and quadriplegic users by eliminating traditional passwords and reducing cognitive load. Neurodivergent users benefit from the automatic loading of personalised settings, and intuitive, frictionless access, while elderly users enjoy simplified authentication that removes the need for memorisation or fine motor skills. Similarly, quadriplegic users can authenticate effortlessly through multimodal inputs such as facial recognition and proximity detection, breaking down barriers to device interaction and ensuring security without added complexity.
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
