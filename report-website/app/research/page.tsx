        ...
        <div className="max-w-4xl">
          <div id="related-projects">
           ...
           <div className="flex flex-col items-center my-6">
            ...
            <p className="text-lg my-6">
              Central to these developments is the use of BLE technology, which offers low power consumption and meticulous distance measurement capabilities. BLE facilitates precise positioning and secure communication between devices, making it ideal for automotive applications where both security and efficiency are vital. By utilising BLE, Alps Alpine's digital key solutions ensure reliable performance while maintaining the security standards required for vehicle access systems.
            </p>          
            <p className="text-lg my-6">
          ...
          <div id="technology-review">
            ...
            <p className="text-lg my-6">
              RFID (Radio Frequency Identification) was considered as an alternative due to its capability for short-range authentication using electromagnetic fields. RFID operates by having a reader emit a radio signal that activates passive RFID tags, enabliing secure identification. Unlike BLE, RFID does not require power on the tag itself, making it highly efficient for authentication solutions. However, RFID is mostly suited for close-range authentication, usually within a few centimeters, which does not align with our requirement for precise proximity detection across a room or workspace. Additionally, RFID does not support real-time distance variation tracking like BLE, making it less suitable for dynamic user-device interaction. Widespread RFID use would also require installing dedicated RFID readers in every interaction zone, increasing both complexity and cost of the system's implementation.
            </p>
            <p className="text-lg my-6">
              Wi-Fi-based positioning was another potential solution that we considered, using signal strength (RSSI), triangulation, and fingerprinting to compute an estimate of a user's location relative to a device. One advantage of Wi-Fi is no additional hardware is required, since most modern buildings are already equipped with Wi-Fi infrastructure, and nearly all devices support Wi-Fi connectivity. However, Wi-Fi-based proximity detection is far less precise than BLE, with typical accuracy ranging from 3 to 5 meters, depending on interference and network conditions. Another major limitation is power consumption: Wi-Fi scanning requires significantly more energy than BLE, making it less suitable for low-power IoT devices such as the ESP32. Moreover, Wi-Fi-based tracking raises several privacy and security concerns, as it often relies on tracking MAC addresses and network data, which could introduce some vulnerabilities. 
            </p>
            <p className="text-lg my-6">
            ...
            <p className="text-lg my-6">
              Facial recognition was selected to be the primary authentication method for our system as it provides a reasonable compromise between security, usability, and accessibility. By utilising facial recognition, users can log in todevices without physical interaction, making it an ideal solution for accessible two-factor authentication (2FA).
            </p>
            <p className="text-lg my-6">
