        ...
        <div className="max-w-4xl">
          <div id="related-projects">
           ...
           <div className="flex flex-col items-center my-6">
            ...
            <p className="text-lg my-6">
              In partnership with Broadcom, Alps Alpine developed a high-accuracy distance measurement system based on BLE technology. This system enables secure keyless entry by accurately determining the proximity of a user's smartphone to the vehicle, allowing for smooth locking and unlocking without physical keys. Broadcom's smartphone Bluetooth and Wi-Fi® combo chip supports these high-accuracy distance measurements, ensuring both security and convenience for users.
            </p>          
            <p className="text-lg my-6">
          ...
          <div id="technology-review">
            ...
            <p className="text-lg">
            Proximity detection is a critical component of our system, enabling users to readily interact with nearby devices while maintaining security and profile-based access control. Various technologies were evaluated for this purpose, including Bluetooth Low Energy (BLE), Near-Field Communication (NFC), Radio Frequency Identification (RFID), and Wi-Fi-based positioning. </p>
            <p className="text-lg my-6">
            ...
            <p className="text-lg my-6">
              Ultimately, BLE's balance of affordability, efficiency, and compatibility makes it the ideal solution for enabling frictionless, profile-based authentication across multiple devices in real-world environments, which is why we selected this option for use in our QPG system. 
            </p>
            <h1 className="text-2xl font-bold my-6">Facial Recognition for Authentication</h1>
            <p className="text-lg my-6">
              Facial recognition was selected as the primary authentication method for our system due to its balance of security, ease of use, and accessibility. By utilising facial recognition, users can gain access to devices without requiring physical interaction, making it an ideal solution for accessible two-factor authentication (2FA).
            </p>
            <p className="text-lg my-6">
