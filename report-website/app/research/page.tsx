      ...
      <div className="flex justify-center p-6">
        <div className="max-w-4xl">
          ...
          <div id="technology-review">
            ...
            <p className="text-lg">
            The development of our QPG system involved multiple programming languages to optimise performance across different components.            </p>
            <p className="text-lg my-6">
            Python 3.11 serves as the primary backend language due to its extensive ecosystem of libraries and ease of integration with machine learning, cryptography, and IoT frameworks. We used Python for implementing facial recognition, managing BLE proximity detection, and handling API communication. The flexibility of Python enables rapid development while maintaining a high level of security.            </p>
            <p className="text-lg my-6">
