      ...
      <div className="flex justify-center p-6">
        <div className="max-w-4xl">
          <div id="abstract">
            ...
            <p className="text-lg">
              As such, we have created the Quantum Proximity Gateway. Our solution integrates facial recognition technology with complex IoT infrastructure to enable effortless computer access based on user proximity and identity profiles. Our system design allows for a centralised ecosystem of devices to seamlessly communicate with each other, forming a robust and interconnected network of QPG-enabled devices, across which, encrypted user profiles and settings can be interacted with using AI Proximity Agents. Robust security and privacy controls are prioritised within the system, with post-quantum encryption ensuring that users' profiles and settings remain proected, and the system . By integrating quantum-maintaining robust security and privacy controls.            </p>
          </div>
          <div id="video">
